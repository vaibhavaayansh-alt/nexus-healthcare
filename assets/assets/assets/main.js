...
(function() {
    ...
    function initScrollReveal() {
        const revealElements = document.querySelectorAll(
            '.feature-card, .topic-card, .service-card, .doctor-card, .scheme-card, .library-card, .emergency-card, .rural-card'
        );
    ...
    // ========================================
    // 8. PARALLAX HERO EFFECT (optional)
    // ========================================
    ...
    // ========================================
    // Make hamburger accessible via keyboard
    if (hamburger) {
    ...
    // ========================================
    // 12. CONSOLE WELCOME (developer friendly)
    // ========================================
...
(function() {
    // This will be populated by health-library.html
    // but we check if the elements exist
    ...
    if (filterButtons.length > 0) {
        filterButtons.forEach(function(btn) {
            btn.addEventListener('click', function() {
                ...
                // If search is active, apply search filter too
